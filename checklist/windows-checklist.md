...
- [ ] Set up Firewall in Settings. (Simply Settings > Search > “firewall”, click the top result and turn on firewall OR Control Panel -> Windows Defender Firewall)
...
- [ ] Enable Automatic Updates (gpedit.msc -> Administrative Templates -> Windows Components -> Windows Update -> Configure Automatic Updates)
